...
namespace ISynergy.Framework.Windows.Dialogs
{
    ...
    public class FolderPickerSettings
    {
        ...
        /// <remarks>By default, the label text of the commit button is <b>Pick Folder</b>.</remarks>
        public string CommitButtonText { get; set; } = string.Empty;

        /// <summary>
        /// Gets the collection of file types that the folder picker displays.
        /// </summary>
        /// <value>A <see cref="IEnumerable{String}" /> object that contains a collection of file types
        /// (file name extensions) , such as ".doc" and ".png". File name extensions are stored in
        /// this array as string objects.</value>
        ...
        /// <remarks>If your application uses multiple instances of the folder picker, you can use this
