...
namespace ISynergy.Framework.Windows.Dialogs
{
    ...
    public class FileSavePickerSettings
    {
        ...
        /// </summary>
        /// <value>The commit button text.</value>
        /// <remarks>By default, the label text of the commit button is <b>Save</b>.</remarks>
        ...
        /// file.
        /// </summary>
        /// <value>A <see cref="IDictionary{String, IList}" /> object that contains a collection of
        ...
        /// or more extension choices.</value>
        /// <remarks>Some apps do not need to understand a file format in order to process it - such as a
        ...
        /// displayed in the UI in the order that you place the extensions in the vector.</remarks>
        ...
        /// <remarks>If your application uses multiple instances of the file save picker, you can use this
        /// property to identify the individual instances.</remarks>
        public string SettingsIdentifier { get; set; } = string.Empty;

        /// <summary>
        /// Gets or sets the file name that the file save picker suggests to the user.
        /// </summary>
        /// <value>The name of the suggested file.</value>
        ...
        /// for saving a file.
        /// </summary>
        /// <value>The suggested save file.</value>
        ...
        /// <remarks>The <see cref="SuggestedStartLocation" /> is not always used as the start location for
        /// the file picker. To give the user a sense of consistency, the file picker remembers the
        /// last location that the user navigated to and will generally start at that location.</remarks>
