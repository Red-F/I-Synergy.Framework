...
namespace ISynergy.Framework.Windows.Dialogs
{
    ...
    public class FileOpenPickerSettings
    {
        ...
        /// <remarks>By default, the label text of the commit button is <b>Open</b>.</remarks>
        ...
        /// </summary>
        /// <value>A <see cref="IList{String}" /> object that contains a collection of file types
        /// (file name extensions) , such as ".doc" and ".png". File name extensions are stored in
        /// this sequence as string objects.</value>
        ...
        /// <remarks>If your application uses multiple instances of the file open picker, you can use this
        ...
        /// <remarks>The <b>SuggestedStartLocation</b> is not always used as the start location for the
