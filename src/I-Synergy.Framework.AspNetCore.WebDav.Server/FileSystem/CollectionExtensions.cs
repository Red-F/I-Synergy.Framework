...
using ISynergy.Framework.AspNetCore.WebDav.Server.FileSystem.Mount;
...
namespace ISynergy.Framework.AspNetCore.WebDav.Server.FileSystem
{
    ...
    public static class CollectionExtensions
    {
        ...
        private class FileSystemEntries : IAsyncEnumerable<IEntry>
        {
            ...
            public IAsyncEnumerator<IEntry> GetAsyncEnumerator(CancellationToken cancellationToken)
            {
